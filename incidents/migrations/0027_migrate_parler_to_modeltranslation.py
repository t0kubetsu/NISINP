...
def migrate_parler_to_modeltranslation(apps, schema_editor):
    ...
    to the new modeltranslation field-suffix pattern (label_en, label_fr, label_nl, label_de).
    """
    # List of incidents models and their translated fields to migrate
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("incidents", "0026_alter_sectorregulationworkfloweemail_headline"),
    ]
