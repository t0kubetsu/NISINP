...
class IncidentFilter(django_filters.FilterSet):
    ...
    def filter_search(self, queryset, name, value):
        return queryset.filter(
            ...
            | Q(regulator__name__icontains=value)
            | Q(regulator__full_name__icontains=value)
            | Q(sector_regulation__regulation__label__icontains=value)
            | Q(affected_sectors__name__icontains=value)
        ).distinct()
